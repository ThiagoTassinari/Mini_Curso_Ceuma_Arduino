//Father's Day motion activated Star Wars song.
//Supplies: Arduino Uno, 2 LEDs, 2 1kOhm resistors, 
//piezo buzzer, PIR motion detector, jumper wires
//www.rosieresearch.com

//create musical notes
//Buzzer code via Nick Sort at 
